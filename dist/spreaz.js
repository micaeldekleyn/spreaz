(function (global, factory) {
  ...
  (global = global || self, factory(global.spreaz = {}, global.React, global.styled));
  ...
  var theming = function theming(_ref) {
    ...
    if (undefined(theme, path)) {
      return undefined(theme, path);
    } else {
      return defaultValue;
    }
  };
  ...
  var StyledButton = styled__default.button(_templateObject(), function (_ref) {
    ...
    return border && styled.css(["position:relative;width:calc(100% - 2px);color:", ";background:", ";margin:1px;:before{content:'';position:absolute;top:0;right:0;bottom:0;left:0;z-index:-1;margin:-1px;border-radius:inherit;background:linear-gradient(90deg,", " 0%,", " 100%);}"], function (_ref15) {
    ...
    return round && styled.css(["border-radius:24px;"]);
  }, function (_ref20) {
  ...
  var Label = styled__default.label(_templateObject$1(), function (_ref) {
    var theme = _ref.theme;
    return theming({
      theme: theme,
  ...
  var StyledInput = styled__default.input(_templateObject2(), FontFamilies.Secondary, FontSizes.input, Colors.Neutral, function (_ref4) {
  ...
  var Input = function Input(_ref6) {
    ...
    return React.createElement(Label, {
      "for": id
    }, label, React.createElement(StyledInput, _extends({
      name: id,
      id: id
    }, props)));
  };
  ...
  var Row = styled__default.div(_templateObject$2(), function (_ref) {
    var outterMargin = _ref.outterMargin;
    return !outterMargin && styled.css(["margin-left:-", "px;margin-right:-", "px;"], Layout.Gutters / 2, Layout.Gutters / 2);
  });
  var StyledCol = styled__default.div(_templateObject2$1(), function (_ref2) {
    var span = _ref2.span;
    return 100 / Layout.Columns * span + "%";
  }, Layout.Gutters, function (_ref3) {
    var span = _ref3.span;
    return 100 / Layout.Columns * span + "%";
  }, Layout.Gutters);

  var Col = function Col(props) {
    return React.createElement(StyledCol, props);
  };
  ...
  var StyledTitle = styled__default.h1(_templateObject$3(), FontFamilies.Primary, function (_ref) {
    var level = _ref.level;
    return FontSizes[level];
  }, function (_ref2) {
    var level = _ref2.level;
    return LineHeights[level];
  }, Colors.NeutralDark, function (_ref3) {
  ...
  var StyledText = styled__default.p(_templateObject$4(), FontFamilies.Secondary, function (_ref) {
    var level = _ref.level;
    return FontSizes.p[level];
  }, function (_ref2) {
    var level = _ref2.level;
    return LineHeights.p[level];
  }, Colors.NeutralDark, function (_ref3) {
    var centered = _ref3.centered,
        _ref3$align = _ref3.align,
        align = _ref3$align === void 0 ? "left" : _ref3$align;
